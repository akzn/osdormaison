...
<head>
    ...
    <title>Osdormaison</title>

    <!-- Bootstrap Core CSS -->
    <link href="<?=BASE?>assets/plugin/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="<?=BASE?>assets/plugin/font-awesome/css/font-awesome.min.css">
    <!-- Custom CSS -->
    ...
    <script src="<?=BASE?>assets/plugin/bootstrap/js/bootstrap.min.js"></script>
...
<body>
    <header>
        ...
        <div class="row header-middle hidden">
            <div class="col-sm-6">
                <img class="img-responsive" src="<?=BASE?>images/logo2.jpg" width="100">
            </div>
            <div class="col-sm-6">
                <div class="row">
